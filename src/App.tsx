  ...
  return (
    <div className="min-h-screen flex flex-col">
                    ...
                    filteredProducts.map((product, idx) => (
                      ...
                      >
                        ...
                        <div className="p-2 sm:p-6">
                          ...
                          <h3 className="font-serif text-sm sm:text-base font-semibold text-green-dark mb-2">{product.title}</h3>
                  ...
                  {PRODUCTS.filter(p => p.vendor === 'Aastha' || p.tags.includes('ritual') || p.tags.includes('pooja')).map((product, idx) => (
                    ...
                    >
                      ...
                      <div className="p-4 text-center">
                        ...
                        <h3 className="font-serif text-[13px] sm:text-sm font-semibold text-green-dark mb-2">{product.title}</h3>
                    ...
                    <div key={tale.id} className="min-w-[260px] sm:min-w-[300px] snap-start group bg-white shadow-md hover:shadow-xl transition-all duration-500 rounded-xl overflow-hidden border border-gray-100">
                      ...
                      <div className="p-5 bg-white flex gap-4 items-start">
                        ...
                        <div className="flex-1">
                          <h4 className="text-[11px] font-bold text-green-dark mb-1">{tale.title}</h4>
                    ...
                    <div className="space-y-4 mb-6 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                      {cart.map((item) => (
                        <div key={item.handle} className="flex gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="text-[11px] font-bold text-green-dark">{item.title}</h4>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-6 right-6 z-[400] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:bg-[#20ba5a] transition-colors"
